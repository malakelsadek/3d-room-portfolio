  ...
  return (
    <div className="absolute inset-0 text-white select-none">
      ...
      <motion.div
        ...
        className="absolute bottom-28 sm:bottom-20 left-4 sm:left-8 md:left-20 right-4 sm:right-auto pointer-events-auto bg-purple-950/50 rounded-2xl px-5 py-4 sm:bg-transparent sm:rounded-none sm:px-0 sm:py-0"
      >
      ...
      <motion.div
        ...
        className="absolute top-[12%] sm:top-1/2 right-4 sm:right-8 md:right-20 left-4 sm:left-auto sm:-translate-y-1/2 pointer-events-auto bg-purple-950/50 rounded-2xl px-5 py-4 sm:bg-transparent sm:rounded-none sm:px-0 sm:py-0"
      >
